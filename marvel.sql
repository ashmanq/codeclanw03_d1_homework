DROP TABLE movies;
DROP TABLE people;
DROP RELATION ironman_3_showtime;
...
SELECT * FROM movies WHERE title = 'Iron Man 2'; -- Search for time for Iron Man 2 showing
UPDATE movies SET show_time = '20:45' WHERE title = 'Iron Man 3'; -- Update Iron Man 3 showing to Iron Man 2 showing + 2 hours
...
SELECT name FROM people; -- (* could have been used as table only has one column)


-- Extension delete multiple entries
-- Delete all movies in year 2017
---------------------------------------
